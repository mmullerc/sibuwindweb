  ...
  <b-container fluid>
    ...
    <b-row>
      <b-col class="advancedBtn insp-btns">
        <b-button class="right" variant="outline-primary">Add Component</b-button>
      </b-col>
    </b-row>
    <br>
...
const items = [
  { componentType: 'Blade', componentNumber: '2334', model: 'LM43', 'dateManufactered': '28/11/2017', dateOperation: '7/2/2018', 'manufaturer': 'LM'  },
  { componentType: 'Blade', componentNumber: '2335', model: 'LM43', 'dateManufactered': '12/12/2017', dateOperation: '7/2/2018', 'manufaturer': 'LM', },
  { componentType: 'Blade', componentNumber: '2336', model: 'LM43', 'dateManufactered': '10/10/2017', dateOperation: '7/2/2018', 'manufaturer': 'LM', },
  { componentType: 'Blade', componentNumber: '2337', model: 'LM43', 'dateManufactered': '15/12/2017', dateOperation: '7/2/2018', 'manufaturer': 'LM', }
]
  ...
  data () {
    return {
      ...
      fields: [
        ...
        { key: 'componentNumber', lable: 'Number'},
        { key: 'model', lable: 'Model'},
        { key: 'dateManufactered', label: 'Date of manufacture'},
        { key: 'dateOperation', label: 'Date of first operation' },
        { key: 'manufaturer', label: 'Manufacturer' },
